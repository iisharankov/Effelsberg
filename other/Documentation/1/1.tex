...
\addcontentsline{toc}{subsection}{INTERLOCK}
	...
	\begin{itemize}
		...
		\item[] {\bf{DEACTIVATE}}
		\addcontentsline{toc}{subsubsection}{DEACTIVATE}
...
\addcontentsline{toc}{subsection}{HEXAPOD}
	...
	\begin{itemize}
		...
		\addcontentsline{toc}{subsubsection}{SETABS}
			\begin{itemize}
		...
		\item[] {\bf{GETABS}}
		\addcontentsline{toc}{subsubsection}{GETABS}
		...
		\item[] {\bf{STOP}}
		\addcontentsline{toc}{subsubsection}{STOP}
			\subitem{Immediately stops the hexapod?}

		\item[] {\bf{INTERLOCK}}
		\addcontentsline{toc}{subsubsection}{INTERLOCK}
...
\addcontentsline{toc}{subsection}{ASF}
	...
	\begin{itemize}
			...
			\item[] {\bf{REST}}
			\addcontentsline{toc}{subsubsection}{REST}
			\subitem{-----}
			
		\item[] {\bf{PRESET}}
		\addcontentsline{toc}{subsubsection}{PRESET}
			\subitem{-----}

		\item[] {\bf{AUTO}}
		\addcontentsline{toc}{subsubsection}{AUTO}
			\subitem{-----}

		\item[] {\bf{OFFSET}}
		\addcontentsline{toc}{subsubsection}{OFFSET}
			\subitem{-----}
			
		\item[] {\bf{IGNORE}}
		\addcontentsline{toc}{subsubsection}{IGNORE}
		...
		\item[] {\bf{ERROR}}
		\addcontentsline{toc}{subsubsection}{ERROR}
