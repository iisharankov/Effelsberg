...
assert (ctypes.sizeof(pkg())) == 58
# print(ctypes.sizeof(pkg()))

# Creates a instance of the structure
struct_instance = pkg(startflag, 58, 12345, cmd_il, mode, elevation, reserve, endflag)
...
cbytes = b'\x1a\xcf\xfc\x1d\x00\x00\x00\x00:\x00\x00\x00\x00\x00\x00\x00\xcb/\x00\x00\x00\x00\x00\x00j\x00\x00\x00\x00\x00\x00\x00\xd0\x07\x00\x00\x00\x00\x00\x00*@\x00\x00\x00\x00\x00\x00\x00\x00\xd1\xcf\xfc\xa1\x00\x00\x00\x00'
print(f"Cbytes: \n {cbytes}")

cbytes_new = b'\x1a\xcf\xfc\x1d\x00\x00\x00\x00:\x00\x00\x00\x00\x00\x00\x008[\x01\x00\x00\x00\x00\x00j\x00\x00\x00\x00\x00\x00\x00\xd0\x07\x00\x00\x00\x00\x00\x00.@\x00\x00\x00\x00\x00\x00\x00\x00\xd1\xcf\xfc\xa1\x00\x00\x00\x00'
...
unpacked_cpp_bytes_new = Unpack(pkg, cbytes_new)
print('\nUnpackaged C++ bytes as read from the Python server from the file')
print(f'start_flag: {unpacked_cpp_bytes_new.start_flag} \n'
      f'message_length: {unpacked_cpp_bytes_new.message_length} \n'
      f'command_serial_number: {unpacked_cpp_bytes_new.command_serial_number} \n'
      f'command: {unpacked_cpp_bytes_new.command} \n'
      f'mode: {unpacked_cpp_bytes_new.mode} \n'
      f'elevation: {unpacked_cpp_bytes_new.elevation} \n'
      f'reserved: {unpacked_cpp_bytes_new.reserved} \n'
      f'end_flag: {unpacked_cpp_bytes_new.end_flag} \n')
