        ...
        if True:
            ...
            humanData = {
                ...
                'status-data-bottom-flap':
                    {
                        ...
                        'flap1-external error (focus changer in wrong position)': bdkl[11],
                ...
                'status-data-mirror-flap':
                    {
                        'subsystem-status': polar[0],
                        'status': polar[1],
                        'fold-status': polar[2],
                        'latch-status(locking-the-flaps)': polar[3],
                        'collision': polar[4],
                        'collective-status-error': polar[5],
                        'engine': polar[6],
                        'engine': polar[7],
                        'engine': polar[8],
                        'engine': polar[9],
